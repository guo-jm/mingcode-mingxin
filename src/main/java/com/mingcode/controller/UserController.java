...
import com.mingcode.utils.IMoocJSONResult;
import com.mingcode.utils.MD5Utils;
...
import com.mingcode.enums.OperatorFriendRequestTypeEnum;
import com.mingcode.enums.SearchFriendsStatusEnum;
import com.mingcode.pojo.Users;
import com.mingcode.pojo.bo.UsersBO;
import com.mingcode.pojo.vo.MyFriendsVO;
import com.mingcode.pojo.vo.UsersVO;
...
//		"dhawuidhwaiuh3u89u98432_80x80.png"
    ...
    public IMoocJSONResult getUnReadMsgList(String acceptUserId) {
        ...
        // 查询列表
//        List<com.mingcode.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
        List<com.mingcode.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
